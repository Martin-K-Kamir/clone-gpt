...
export function SearchList({
    ...
    return (
        <CommandPrimitive.List
            ...
            className={cn(
                "h-full max-h-full scroll-py-2.5 overflow-y-auto overflow-x-hidden p-0 lg:h-[345px] lg:max-h-[345px] lg:[&:has([cmdk-list-sizer]:empty)]:h-0 [&:has([cmdk-list-sizer]:not(:empty))]:p-2.5",

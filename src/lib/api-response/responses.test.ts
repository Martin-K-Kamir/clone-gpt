...
describe("createApiSuccessResponse", () => {
    describe("basic functionality", () => {
        it("should create ApiSuccessResponse with required parameters", () => {
        ...
        it("should accept different data types", () => {
            const stringData = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                "string",
                "path",
                "message",
            ...
            const numberData = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                42,
                "path",
                "message",
            ...
            const objectData = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                { key: "value" },
                "path",
                "message",
            ...
            const arrayData = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                [1, 2, 3],
                "path",
                "message",
            ...
            const nullData = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                null,
                "path",
                "message",
    ...
    describe("toJson", () => {
        ...
        it("should be JSON serializable (no methods in JSON)", () => {
            const response = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                "data",
                "path",
            ...
            expect(parsed.toResponse).toBeUndefined();
        });
    });
    ...
    describe("proxy behavior", () => {
        ...
        it("should provide toJson and toResponse methods", () => {
            const response = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                "data",
                "path",
            ...
            expect(typeof response.toJson).toBe("function");
            expect(typeof response.toResponse).toBe("function");
        });

        it("should be enumerable (Object.keys should work)", () => {
            const response = createApiSuccessResponse(
                HTTP_SUCCESS_STATUS.OK,
                "data",
                "path",
            ...
            expect(keys).not.toContain("toResponse");
        });
    });
    ...
    describe("type tests", () => {
        ...
        it("should preserve generic data type", () => {
            ...
            const response = createApiSuccessResponse<CustomData>(
                HTTP_SUCCESS_STATUS.OK,
                { id: 1, name: "Test" },
                "path",
                "message",
...
describe("createApiErrorResponse", () => {
    describe("basic functionality", () => {
        it("should create ApiErrorResponse without error", () => {
        ...
        it("should create ApiErrorResponse with error", () => {
            const errorDetails = {
                code: "ERROR_001",
        ...
        it("should create ApiErrorResponse with error and data", () => {
    ...
    describe("type tests", () => {
        ...
        it("should preserve generic error type", () => {
            ...
            const response = createApiErrorResponse<CustomError>(
                HTTP_ERROR_STATUS.BAD_REQUEST,
                "path",
                "message",
